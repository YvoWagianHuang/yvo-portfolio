...
export const portfolioData = {
  ...
  about: {
    ...
    manifesto: {
      zh: "伊理教育取自於創辦人伊芙的名字，以及我們對理性思維的追求\n我們的目標是：讓所有人都愛上學習\n孩子是時代的未來，而教育就是時代的最前沿\n伊理教育希冀透過教育科技，解決傳統教育長久的限制\n重新定義教育的方法，\n我們相信自己一定能做到\n也邀請你一起顛覆傳統\n\n我們提供以下的服務\n1. 為你或你的子女量身定做學科教材與實體＆線上課程\n2. 陪伴各位老師優化或設計教材\n3. 為你的機構設計線上課程＆教材\n4. 接受採訪與講座邀請，分享前沿教育科技理論",
      en: "Yili Education derives its name from founder Yvo and our pursuit of rational thinking.\nOur goal is to let everyone love learning.\nChildren are the future, and education is the forefront of the era.\nYili Education hopes to use EdTech to solve the long-standing limitations of traditional education and redefine educational methods.\nWe believe we can do it, and we invite you to disrupt tradition together.\n\nWe provide the following services:\n1. Tailor-made academic materials and courses (offline & online) for you or your children.\n2. Accompany teachers to optimize or design materials.\n3. Design online courses and materials for your institution.\n4. Accept interview and lecture invitations to share cutting-edge EdTech theories."
    },
